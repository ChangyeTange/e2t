...
import numpy as np
from e2t.data import DataGenerator
...
class RI(BaseNN):
    ...
    def __init__(self, **kwargs):
        super(RI, self).__init__(**kwargs)

        self.mus = RI.kernal_mus(self.n_bins, use_exact=True)
        self.sigmas = RI.kernel_sigmas(self.n_bins, self.lamb, use_exact=True)
